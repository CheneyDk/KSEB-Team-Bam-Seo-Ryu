...
public class RangeEnemy : Enemy
{
    ...
    public float RangeEnemyMaxHp = 10f;
    public float RangeEnemyAtk = 3f;
    public float RangeEnemyMoveSpeed = 7f;
    public float playerEnemyRange = 15f;
...
public class RangeEnemyMoveState : IEnemyState
{
    ...
    public RangeEnemyMoveState(RangeEnemy enemy)
    {
        this.enemy = enemy;
    }
...
public class RangeEnemyAttackState : IEnemyState
{
    private RangeEnemy enemy;

    public RangeEnemyAttackState(RangeEnemy enemy)
    {
        this.enemy = enemy;
    }
    ...
    private IEnumerator AttackRoutine()
    {
        while (true)
        {
            if (enemy.canAttack)
            {
                ...
                GameObject bullet = enemy.GetPooledEnemies(enemy.pooledEnemyBullet);
                if (bullet != null)
                {
